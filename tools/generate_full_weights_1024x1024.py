...
if __name__ == "__main__":
    ...
    parser.add_argument("dinov2_segmentor_path", help="Path to the DINOv2 segmentor checkpoint")
    parser.add_argument("backbone", help="Path to the DINOv2 backbone weights")
    parser.add_argument("rein_head", help="Path to the REIN weights")
